...
public class GoodsSortRightAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    private List<StoreBean> mRightData;
    private SwipeMenuRecyclerView swipeMenuRecyclerView;

    public GoodsSortRightAdapter(List<StoreBean> goodsList, SwipeMenuRecyclerView swipeMenuRecyclerView) {
