...
public class HiDialog extends DialogFragment implements View.OnClickListener {
    ...
    private void setData() {
        ...
        mTvContent.setText(String.valueOf(getArguments().getString("content")));

        if (TextUtils.isEmpty(getArguments().getString("leftBtnText"))) {
        ...
        if (TextUtils.isEmpty(getArguments().getString("rightBtnText"))) {
