...
//            return;
    ...
    public boolean checkDeviceHasNavigationBar() {
        ...
        try {
            ...
            com.andlei.utils.Logger.e(getName(), e);
        }
    ...
    public void jumpTo(Class<?> targetActivity) {
        ...
        if (getPackageManager().resolveActivity(intent, PackageManager.MATCH_DEFAULT_ONLY) != null) {
            ...
            com.andlei.utils.Logger.e(getName(), "mActivity not found for " + targetActivity.getSimpleName());
        }
    }
...
//                break;
    ...
    public static void backTo(Class<?> targetActivity) {
        ...
        if (activitiesMap.get(targetActivity) != null)
            ...
            com.andlei.utils.Logger.e(activities.get(size - 1).getClass().getSimpleName(), "mActivity not open for " + targetActivity.getSimpleName());
    }
