 ...
 */
public abstract class BaseFragmentActivity extends activity.BaseLayoutActivity {
    ...
    public void addFragment(int containerViewId, Fragment... fragments) {
        ...
        if (fragments != null) {
            ...
            com.andlei.utils.Logger.e(getName(), "没有Fragment");
        }
    }
    ...
    public void showFragment(Fragment fragment) {
        ...
        if (fragment != null) {
            ...
            com.andlei.utils.Logger.e(getName(), "ragment不存在");
        }
    }
