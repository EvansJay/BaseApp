...
import receiver.NetBroadcastReceiver;
...
public abstract class BaseLayoutActivity extends BaseActivity implements NetBroadcastReceiver.NetEvent, View.OnClickListener {
    ...
    public void hideBack() {
        if (null != baseBack) {
            ...
            com.andlei.utils.Logger.e(getName(), "baseBack is not exist!");
        }
    }
    ...
    public void setTitle(String title, boolean showBack) {
        ...
        if (com.andlei.utils.Const.isEmpty(baseBack)) {
    ...
    public void hideBaseClose() {
        if (null != baseClose) {
            ...
            com.andlei.utils.Logger.e(getName(), "baseClose is not exist");
        }
    }
    ...
    public ImageView setBaseRightIcon2(int resId, String alertText) {
        ...
        if (null != baseRightIcon1) {
            ...
            com.andlei.utils.Logger.e(getName(), "You must inflate the baseRightIcon1 before use baseRightIcon2!");
        }
